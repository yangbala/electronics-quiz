const chapter2Questions = {
  "111-36": {
    ...
    blanks:[
      ...
      {a:"3|1+10/5", label:"②", why:"反相端是標準非反相放大器回授網路，閉迴路增益為 \\(1+R_f/R_g=3\\)。"},
      {a:"(v_+-V_1)/10k+(v_+-V_2)/10k+v_+/R_S=0|(v+-V1)/10k+(v+-V2)/10k+v+/Rs=0", label:"③", why:"同相端不吸收電流，所以流經三個電阻的電流代數和為零。"},
      {a:"2+10k/R_S=3|2+10k/Rs=3", label:"④", why:"要讓 \\(v_o=V_1+V_2\\)，分母必須等於前級增益 3。"},
      {a:"10kΩ|10k|10 kΩ|10kOhm", label:"⑤", why:"由 \\(10\\,\\mathrm{k}\\Omega/R_S=1\\) 得 \\(R_S=10\\,\\mathrm{k}\\Omega\\)。"}
    ],
  ...
  "111-49": {
    ...
    blanks:[
      ...
      {a:"1kΩ|1k|1 kΩ",label:"③",why:"由量測增益 \\(-5/1=-5\\) 與 \\(-5\\,\\mathrm{k}\Omega/R_1\\) 比較。"},
      {a:"V_o/V_x=1+10k/R_2|Vo/Vx=1+10k/R2",label:"④",why:"第二級訊號接同相端，因此是非反相放大器。"},
      {a:"10kΩ|10k|10 kΩ",label:"⑤",why:"第二級量測增益為 \\((-10)/(-5)=2\\)，故 \\(10k/R_2=1\\)。"}
    ],
    ...
    self:"兩級輸出都為負值，為什麼第二級仍是『非反相』？請以 \(V_o/V_x\) 的符號，而不是只看對地電壓正負回答。",
  ...
  "112-40": {
    ...
    blanks:[
      {a:"v_-=v_+=4V|v-=v+=4V|4V",label:"①",why:"同相端串聯電阻無電流、無壓降，所以 \\(v_+=4\\,V\\)；負回授使 \\(v_-=v_+\\)。"},
      {a:"V_x=V_o-4V|Vx=Vo-4V",label:"②",why:"回授電池右正左負，因此 \\(V_o-V_x=4\\,V\\)。"},
      {a:"(v_--V_x)/1k=2mA|(v--Vx)/1k=2mA",label:"③",why:"運放輸入不吸電流，2 mA 必須全部流入回授支路。"},
      {a:"8-V_o=2|8-Vo=2",label:"④",why:"把 \\(v_-=4\\,V\\) 與 \\(V_x=V_o-4\\,V\\) 代入 KCL。"},
      {a:"6V|6 V",label:"⑤",why:"完整方程式解得 \\(V_o=6\\,V\\)，且在 \\(\\pm15\\,V\\) 電源範圍內。"}
    ],
  ...
  "113-38": {
    ...
    choices:["15","12","8","6"],
    blanks:[
      {a:"v_A=v_i|vA=vi",label:"①",why:"同相端接 \\(v_i\\)，負回授使反相端節點 A 與之等電位。"},
      ...
      {a:"8|A_v=8|Av=8",label:"⑤",why:"代入 \\(v_B=2v_A\\) 後得到 \\(v_o=8v_A=8v_i\\)。"}
    ],
    ...
    self:"本題為何只由電阻比決定增益，而與 \(R=100\\,k\\Omega\) 的絕對值無關？",
  ...
  "113-39": {
    ...
    blanks:[
      ...
      {a:"12V|12 V",label:"⑤",why:"完整代入得到 \\(v_o=12\\,V\\)，未超過正電源 15 V。"}
    ],
  ...
  "114-36": {
    ...
    blanks:[
      ...
      {a:"0.4mS|0.4 mS",label:"③",why:"總電導為 \\(1/20k+1/20k+1/10k+1/5k=0.4\\,mS\\)。"},
      {a:"1+20k/10k=3|3",label:"④",why:"反相端回授形成非反相增益 3。"},
      {a:"30mV|30 mV",label:"⑤",why:"\\(v_+=4\\,µA/0.4\\,mS=10\\,mV\\)，再乘 3 得 30 mV。"}
    ],
  ...
  "115-47": {
    ...
    choices:["4","3","2","1"],
    blanks:[
      {a:"v_+=3R_f/(R+R_f)|v+=3Rf/(R+Rf)",label:"①",why:"同相端由 3 V 經 R 與對地 \\(R_f\\) 分壓，運放輸入不取電流。"},
      ...
      {a:"4",label:"⑤",why:"由 \\(8=2R_f/R\\) 得 \\(R_f/R=4\\)。"}
    ],
    ...
    self:"本電路為何會得到 \(v_o=(R_f/R)(3-1)\)，但前提是同相端也使用相同比例的 R 與 \(R_f\)？",
